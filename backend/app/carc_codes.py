...
REMITTANCE_ADVICE_REMARK_CODES: dict[str, str] = {
    ...
    'M4': 'Alert:\xa0This is the last monthly installment payment for this durable medical equipment.',
    ...
    'M6': 'Alert:\xa0You must furnish and service this item for any period of medical need for the remainder of the reasonable useful lifetime of the equipment.',
    ...
    'M9': 'Alert:\xa0This is the tenth rental month. You must offer the patient the choice of changing the rental to a purchase agreement.',
    ...
    'M16': 'Alert:\xa0Please see our web site, mailings, or bulletins for more details concerning this policy/procedure/decision.',
    'M17': 'Alert:\xa0Payment approved as you did not know, and could not reasonably have been expected to know, that this would not normally have been covered for this patient. In the future, you will be liable for charges for the same service(s) under the same or similar conditions.',
    ...
    'M32': "Alert:\xa0This is a conditional payment made pending a decision on this service by the patient's primary payer. This payment may be subject to refund upon your receipt of any additional payment for this service from another payer. You must contact this office immediately upon receipt of an additional payment for this service.",
    ...
    'M38': 'Alert:\xa0The patient is liable for the charges for this service as they were informed in writing before the service was furnished that we would not pay for it and the patient agreed to be responsible for the charges.',
    'M39': 'Alert:\xa0The patient is not liable for payment of this service as the advance notice of non-coverage you provided the patient did not comply with program requirements.',
    ...
    'M70': 'Alert:\xa0The NDC code submitted for this service was translated to a HCPCS code for processing, but please continue to submit the NDC on future claims for this item.',
    ...
    'MA01': 'Alert:\xa0If you do not agree with what we approved for these services, you may appeal our decision. To make sure that we are fair to you, we require another individual that did not process your initial claim to conduct the appeal. However, in order to be eligible for an appeal, you must write to us within 120 days of the date you received this notice, unless you have a good reason for being late.',
    'MA02': 'Alert:\xa0If you do not agree with this determination, you have the right to appeal. You must file a written request for an appeal within 180 days of the date you receive this notice.',
    ...
    'MA07': 'Alert:\xa0The claim information has also been forwarded to Medicaid for review.',
    'MA08': 'Alert:\xa0Claim information was not forwarded because the supplemental coverage is not with a Medigap plan, or you do not participate in Medicare.',
    'MA09': 'Alert:\xa0Claim submitted as unassigned but processed as assigned in accordance with our current assignment/participation agreement.',
    'MA10': "Alert:\xa0The patient's payment was in excess of the amount owed. You must refund the overpayment to the patient.",
    ...
    'MA13': 'Alert:\xa0You may be subject to penalties if you bill the patient for amounts not reported with the PR (patient responsibility) group code.',
    'MA14': 'Alert:\xa0The patient is a member of an employer-sponsored prepaid health plan. Services from outside that health plan are not covered. However, as you were not previously notified of this, we are paying this time. In the future, we will not pay you for non-plan services.',
    'MA15': 'Alert:\xa0Your claim has been separated to expedite handling. You will receive a separate notice for the other services reported.',
    ...
    'MA18': "Alert:\xa0The claim information is also being forwarded to the patient's supplemental insurer. Send any questions regarding supplemental benefits to them.",
    'MA19': 'Alert:\xa0Information was not sent to the Medigap insurer due to incorrect/invalid information you submitted concerning that insurer. Please verify your information and submit your secondary claim directly to that insurer.',
    ...
    'MA26': 'Alert:\xa0Our records indicate that you were previously informed of this rule.',
    'MA27': 'Missing/incomplete/invalid entitlement number or name shown on the claim.',
    'MA28': 'Alert:\xa0Receipt of this notice by a physician or supplier who did not accept assignment is for information only and does not make the physician or supplier a party to the determination. No additional rights to appeal this decision, above those rights already provided for by regulation/instruction, are conferred by receipt of this notice.',
    ...
    'MA44': 'Alert:\xa0No appeal rights. Adjudicative decision based on law.',
    'MA45': 'Alert:\xa0As previously advised, a portion or all of your payment is being held in a special account.',
    'MA46': 'Alert:\xa0The new information was considered but additional payment will not be issued.',
    ...
    'MA59': 'Alert:\xa0The patient overpaid you for these services. You must issue the patient a refund within 30 days for the difference between his/her payment and the total amount shown as patient responsibility on this notice.',
    'MA60': 'Missing/incomplete/invalid patient relationship to insured.',
    'MA61': 'Missing/incomplete/invalid social security number.',
    'MA62': 'Alert:\xa0This is a telephone review decision.',
    ...
    'MA67': 'Alert:\xa0Correction to a prior claim.',
    'MA68': 'Alert:\xa0We did not crossover this claim because the secondary insurance information on the claim was incomplete. Please supply complete information or use the PLANID of the insurer to assure correct and timely routing of the claim.',
    ...
    'MA72': 'Alert:\xa0The patient overpaid you for these assigned services. You must issue the patient a refund within 30 days for the difference between his/her payment to you and the total of the amount shown as patient responsibility and as paid to the patient on this notice.',
    ...
    'MA74': 'Alert:\xa0This payment replaces an earlier payment for this claim that was either lost, damaged or returned.',
    ...
    'MA77': "Alert:\xa0The patient overpaid you. You must issue the patient a refund within 30 days for the difference between the patient's payment less the total of our and other payer payments and the amount shown as patient responsibility on this notice.",
    ...
    'MA91': 'Alert:\xa0This determination is the result of the appeal you filed.',
    ...
    'MA118': 'Alert:\xa0No Medicare payment issued for this claim for services or supplies furnished to a Medicare-eligible veteran through a facility of the Department of Veterans Affairs. Coinsurance and/or deductible are applicable.',
    ...
    'N7': 'Alert:\xa0Processing of this claim/service has included consideration under Major Medical provisions.',
    ...
    'N21': 'Alert:\xa0Your line item has been separated into multiple lines to expedite handling.',
    'N22': 'Alert:\xa0This procedure code was added/changed because it more accurately describes the services rendered.',
    'N23': 'Alert:\xa0Patient liability may be affected due to coordination of benefits with other carriers and/or maximum benefit provisions.',
    ...
    'N59': 'Alert:\xa0Please refer to your provider manual for additional program and provider information.',
    ...
    'N69': 'Alert:\xa0PPS (Prospective Payment System) code changed by claims processing system.',
    ...
    'N84': 'Alert:\xa0Further installment payments are forthcoming.',
    'N85': 'Alert:\xa0This is the final installment payment.',
    ...
    'N88': "Alert:\xa0This payment is being made conditionally. An HHA episode of care notice has been filed for this patient. When a patient is treated under a HHA episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the HHA's payment. This payment will need to be recouped from you if we establish that the patient is concurrently receiving treatment under a HHA episode of care.",
    'N89': 'Alert:\xa0Payment information for this claim has been forwarded to more than one other payer, but format limitations permit only one of the secondary payers to be identified in this remittance advice.',
    ...
    'N109': 'Alert:\xa0This claim/service was chosen for complex review.',
    ...
    'N116': "Alert:\xa0This payment is being made conditionally because the service was provided in the home, and it is possible that the patient is under a home health episode of care. When a patient is treated under a home health episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the home health agency's (HHA's) payment. This payment will need to be recouped from you if we establish that the patient is concurrently receiving treatment under an HHA episode of care.",
    ...
    'N123': 'Alert:\xa0This is a split service and represents a portion of the units from the originally submitted service.',
    ...
    'N132': 'Alert:\xa0Payments will cease for services rendered by this US Government debarred or excluded provider after the 30 day grace period as previously notified.',
    'N133': 'Alert:\xa0Services for predetermination and services requesting payment are being processed separately.',
    'N134': 'Alert:\xa0This represents your scheduled payment for this service. If treatment has been discontinued, please contact Customer Service.',
    'N135': "Record fees are the patient's responsibility and limited to the specified co-payment.",
    'N136': "Alert:\xa0To obtain information on the process to file an appeal in Arizona, call the Department's Consumer Assistance Office at (602) 912-8444 or (800) 325-2548.",
    'N137': "Alert:\xa0The provider acting on the Member's behalf, may file an appeal with the Payer. The provider, acting on the Member's behalf, may file a complaint with the State Insurance Regulatory Authority without first filing an appeal, if the coverage decision involves an urgent condition for which care has not been rendered. The address may be obtained from the State Insurance Regulatory Authority.",
    'N138': "Alert:\xa0In the event you disagree with the Dental Advisor's opinion and have additional information relative to the case, you may submit radiographs to the Dental Advisor Unit at the subscriber's dental insurance carrier for a second Independent Dental Advisor Review.",
    ...
    'N154': "Alert:\xa0This payment was delayed for correction of provider's mailing address.",
    'N155': 'Alert:\xa0Our records do not indicate that other insurance is on file. Please submit other insurance information for our records.',
    'N156': 'Alert:\xa0The patient is responsible for the difference between the approved treatment and the elective treatment.',
    ...
    'N162': 'Alert:\xa0Although your claim was paid, you have billed for a test/specialty not included in your Laboratory Certification. Your failure to correct the laboratory certification information will result in a denial of payment in the near future.',
    ...
    'N177': "Alert:\xa0We did not send this claim to patient's other insurer. They have indicated no additional payment can be made.",
    ...
    'N183': 'Alert:\xa0This is a predetermination advisory message, when this service is submitted for payment additional documentation as specified in plan documents will be required to process benefits.',
    'N184': 'Rebill technical and professional components separately.',
    'N185': 'Alert:\xa0Do not resubmit this claim/service.',
    ...
    'N187': 'Alert:\xa0You may request a review in writing within the required time limits following receipt of this notice by following the instructions included in your contract or plan benefit documents.',
    'N188': 'The approved level of care does not match the procedure code submitted.',
    'N189': "Alert:\xa0This service has been paid as a one-time exception to the plan's benefit restrictions.",
    'N190': 'Missing contract indicator.',
    'N191': 'The provider must update insurance information directly with payer.',
    'N192': 'Alert:\xa0Patient is a Medicaid/Qualified Medicare Beneficiary.',
    'N193': 'Alert:\xa0Specific federal/state/local program may cover this service through another payer.',
    ...
    'N196': 'Alert:\xa0Patient eligible to apply for other coverage which may be primary.',
    ...
    'N202': 'Alert:\xa0Additional information/explanation will be sent separately.',
    ...
    'N210': 'Alert:\xa0You may appeal this decision.',
    'N211': 'Alert:\xa0You may not appeal this decision.',
    ...
    'N215': 'Alert:\xa0A payer providing supplemental or secondary coverage shall not require a claims determination for this service from a primary payer as a condition of making its own claims determination.',
    ...
    'N220': "Alert:\xa0See the payer's web site or contact the payer's Customer Service department to obtain forms and instructions for filing a provider dispute.",
    ...
    'N358': 'Alert:\xa0This decision may be reviewed if additional documentation as described in the contract or plan benefit documents is submitted.',
    'N359': 'Missing/incomplete/invalid height.',
    'N360': 'Alert:\xa0Coordination of benefits has not been calculated when estimating benefits for this pre-determination. Submit payment information from the primary payer with the secondary claim.',
    'N362': 'The number of Days or Units of Service exceeds our acceptable maximum.',
    'N363': 'Alert:\xa0in the near future we are implementing new policies/procedures that would affect this determination.',
    'N364': 'Alert:\xa0According to our agreement, you must waive the deductible and/or coinsurance amounts.',
    ...
    'N367': 'Alert:\xa0The claim information has been forwarded to a Consumer Spending Account processor for review; for example, flexible spending account or health savings account.',
    'N368': 'You must appeal the determination of the previously adjudicated claim.',
    'N369': 'Alert:\xa0Although this claim has been processed, it is deficient according to state legislation/regulation.',
    'N370': 'Billing exceeds the rental months covered/approved by the payer.',
    'N371': 'Alert:\xa0title of this equipment must be transferred to the patient.',
    ...
    'N381': 'Alert:\xa0Consult our contractual agreement for restrictions/billing/payment information related to these charges.',
    ...
    'N387': "Alert:\xa0Submit this claim to the patient's other insurer for potential payment of supplemental benefits. We did not forward the claim information.",
    ...
    'N400': 'Alert:\xa0Electronically enabled providers should submit claims electronically.',
    ...
    'N432': 'Alert:\xa0Adjustment based on a Recovery Audit.',
    ...
    'N437': 'Alert:\xa0If the injury claim is accepted, these charges will be reconsidered.',
    ...
    'N444': "Alert:\xa0This facility has not filed the Election for High Cost Outlier form with the Division of Workers' Compensation.",
    ...
    'N469': 'Alert:\xa0Claim/Service(s) subject to appeal process, see section 935 of Medicare Prescription Drug, Improvement, and Modernization Act of 2003 (MMA).',
    ...
    'N492': 'Alert:\xa0A network provider may bill the member for this service if the member requested the service and agreed in writing, prior to receiving the service, to be financially responsible for the billed charge.',
    ...
    'N505': 'Alert:\xa0This response includes only services that could be estimated in real-time. No estimate will be provided for the services that could not be estimated in real-time.',
    'N506': "Alert:\xa0This is an estimate of the member's liability based on the information available at the time the estimate was processed. Actual coverage and member liability amounts will be determined when the claim is processed. This is not a pre-authorization or a guarantee of payment.",
    'N507': 'Plan distance requirements have not been met.',
    'N508': 'Alert:\xa0This real-time claim adjudication response represents the member responsibility to the provider for services reported. The member will receive an Explanation of Benefits electronically or in the mail. Contact the insurer if there are any questions.',
    'N509': "Alert:\xa0A current inquiry shows the member's Consumer Spending Account contains sufficient funds to cover the member liability for this claim/service. Actual payment from the Consumer Spending Account will depend on the availability of funds and determination of eligible services at the time of payment processing.",
    'N510': "Alert:\xa0A current inquiry shows the member's Consumer Spending Account does not contain sufficient funds to cover the member's liability for this claim/service. Actual payment from the Consumer Spending Account will depend on the availability of funds and determination of eligible services at the time of payment processing.",
    'N511': 'Alert:\xa0Information on the availability of Consumer Spending Account funds to cover the member liability on this claim/service is not available at this time.',
    'N512': 'Alert:\xa0This is the initial remit of a non-NCPDP claim originally submitted real-time without change to the adjudication.',
    'N513': 'Alert:\xa0This is the initial remit of a non-NCPDP claim originally submitted real-time with a change to the adjudication.',
    ...
    'N520': 'Alert:\xa0Payment made from a Consumer Spending Account.',
    ...
    'N539': 'Alert:\xa0We processed appeals/waiver requests on your behalf and that request has been denied.',
    ...
    'N544': 'Alert:\xa0Although this was paid, you have billed with a referring/ordering provider that does not match our system record. Unless corrected this will not be paid in the future.',
    ...
    'N548': "Alert:\xa0Patient's calendar year deductible has been met.",
    'N549': "Alert:\xa0Patient's calendar year out-of-pocket maximum has been met.",
    'N550': 'Alert:\xa0You have not responded to requests to revalidate your provider/supplier enrollment information. Your failure to revalidate your enrollment information will result in a payment hold in the near future.',
    ...
    'N563': 'Alert:\xa0Missing required provider/supplier issuance of advance patient notice of non-coverage. The patient is not liable for payment for this service.',
    'N564': 'Patient did not meet the inclusion criteria for the demonstration project or pilot program.',
    'N565': 'Alert:\xa0This non-payable reporting code requires a modifier. Future claims containing this non-payable reporting code must include an appropriate modifier for the claim to be processed.',
    'N566': 'Alert:\xa0This procedure code requires functional reporting. Future claims containing this procedure code must include an applicable non-payable code and appropriate modifiers for the claim to be processed.',
    'N567': 'Not covered when considered preventative.',
    'N568': 'Alert:\xa0Initial payment based on the Notice of Admission (NOA) under the Bundled Payment Model IV initiative.',
    'N569': 'Not covered when performed for the reported diagnosis.',
    'N570': 'Missing/incomplete/invalid credentialing data.',
    'N571': 'Alert:\xa0Payment will be issued quarterly by another payer/contractor.',
    'N572': 'This procedure is not payable unless appropriate non-payable reporting codes and associated modifiers are submitted.',
    'N573': 'Alert:\xa0You have been overpaid and must refund the overpayment. The refund will be requested separately by another payer/contractor.',
    ...
    'N610': 'Alert:\xa0Payment based on an appropriate level of care.',
    ...
    'N613': 'Alert:\xa0Although this was paid, you have billed with an ordering provider that needs to update their enrollment record. Please verify that the ordering provider information you submitted on the claim is accurate and if it is, contact the ordering provider instructing them to update their enrollment record. Unless corrected, a claim with this ordering provider will not be paid in the future.',
    'N614': 'Alert:\xa0Additional information is included in the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information).',
    'N615': 'Alert:\xa0This enrollee receiving advance payments of the premium tax credit is in the grace period of three consecutive months for non-payment of premium. Under 45 CFR 156.270, a Qualified Health Plan issuer must pay all appropriate claims for services rendered to the enrollee during the first month of the grace period and may pend claims for services rendered to the enrollee in the second and third months of the grace period.',
    'N616': 'Alert:\xa0This enrollee is in the first month of the advance premium tax credit grace period.',
    'N617': 'This enrollee is in the second or third month of the advance premium tax credit grace period.',
    'N618': 'Alert:\xa0This claim will automatically be reprocessed if the enrollee pays their premiums.',
    'N619': 'Coverage terminated for non-payment of premium.',
    'N620': 'Alert:\xa0This procedure code is for quality reporting/informational purposes only.',
    ...
    'N662': 'Alert:\xa0Consideration of payment will be made upon receipt of a final bill.',
    ...
    'N672': 'Alert:\xa0Amount applied to Health Insurance Offset.',
    ...
    'N677': 'Alert:\xa0Films/Images will not be returned.',
    ...
    'N687': 'Alert:\xa0This reversal is due to a retroactive disenrollment.',
    'N688': 'Alert:\xa0This reversal is due to a medical or utilization review decision.',
    'N689': 'Alert:\xa0This reversal is due to a retroactive rate change.',
    'N690': 'Alert:\xa0This reversal is due to a provider submitted appeal.',
    'N691': 'Alert:\xa0This reversal is due to a patient submitted appeal.',
    'N692': 'Alert:\xa0This reversal is due to an incorrect rate on the initial adjudication.',
    'N693': 'Alert:\xa0This reversal is due to a cancellation of the claim by the provider.',
    'N694': 'Alert:\xa0This reversal is due to a resubmission/change to the claim by the provider.',
    'N695': 'Alert:\xa0This reversal is due to incorrect patient financial responsibility information on the initial adjudication.',
    'N696': 'Alert:\xa0This reversal is due to a Coordination of Benefits or Third Party Liability Recovery retroactive adjustment.',
    'N697': "Alert:\xa0This reversal is due to a payer's retroactive contract incentive program adjustment.",
    'N698': 'Alert:\xa0This reversal is due to non-payment of the health insurance premiums (Health Insurance Exchange or other) by the end of the premium payment grace period, resulting in loss of coverage.',
    ...
    'N704': 'Alert:\xa0You may not appeal this decision but can resubmit this claim/service with corrected information if warranted.',
    ...
    'N720': "Alert:\xa0The patient overpaid you. You may need to issue the patient a refund for the difference between the patient's payment and the amount shown as patient responsibility on this notice.",
    ...
    'N771': 'Alert:\xa0Under Federal law you cannot charge more than the limiting charge amount.',
    'N772': 'Alert:\xa0Rebill urgent/emergent and ancillary services separately.',
    'N773': 'Drug supplied not obtained from specialty vendor.',
    'N774': 'Alert:\xa0Refer to your Third Party Processor Agreement for specific information on fees associated with this payment type.',
    ...
    'N781': 'Alert:\xa0Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected deductible. This amount may be billed to a subsequent payer.',
    'N782': 'Alert:\xa0Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected coinsurance. This amount may be billed to a subsequent payer.',
    'N783': 'Alert:\xa0Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected copayment. This amount may be billed to a subsequent payer.',
    ...
    'N787': 'Alert:\xa0Under 42 CFR 410.43, an eligible Partial Hospitalization Program (PHP) patient/beneficiary requires a minimum of 20 hours of PHP services per week, as evidenced in the plan of care. PHP services must be furnished in accordance with the plan of care.',
    'N788': 'Alert:\xa0The third-party administrator/review organization did not receive the required information.',
    ...
    'N804': 'Alert:\xa0The claim/service was processed through the Outpatient Code Editor (OCE).',
    'N805': 'Alert:\xa0The claim/service was processed through the Correct Code Editor (CCE).',
    ...
    'N809': 'Alert:\xa0The fee schedule amount for this service was adjusted based on prior competitive bidding rates. For more information, contact your local contractor.',
    'N810': 'Alert:\xa0Due to federal, state or local disaster declaration, this claim has been processed at the in-network level of benefit. At the conclusion or expiration of the disaster declaration, network payment rules will be reinstated.',
    ...
    'N817': 'Alert:\xa0Applicable laboratories are required to collect and report private payor data and report that data to CMS between January 1, 2020 - March 31, 2020.',
    ...
    'N837': 'Alert:\xa0Missing modifier was added.',
    'N838': 'Alert:\xa0Service/procedure postponed due to a federal, state, or local mandate/disaster declaration. Any amounts applied to deductible or member liability will be applied to the prior plan year from which the procedure was cancelled.',
    ...
    'N841': 'Alert:\xa0North Dakota Administrative Rule 92-01-02-50.3.',
    'N842': 'Alert:\xa0Patient cannot be billed for charges.',
    ...
    'N845': 'Alert:\xa0Nebraska Legislative LB997 July 24, 2020 - Out of Network Emergency Medical Care Act.',
    ...
    'N854': 'Alert:\xa0If you have primary other health insurance (OHI) coverage that has denied services, you must exhaust all appeal levels with your primary OHI before we can consider your claim for reimbursement.',
    ...
    'N858': "Alert:\xa0State regulations relating to an Out of Network Medical Emergency Care Act were applied to the processing of this claim. Payment amounts are eligible for dispute following the state's documented appeal/ grievance/ arbitration process.",
    'N859': 'Alert:\xa0The Federal No Surprise Billing Act was applied to the processing of this claim. Payment amounts are eligible for dispute pursuant to any Federal documented appeal/ grievance/ dispute resolution process(es).',
    'N860': 'Alert:\xa0The Federal No Surprise Billing Act Qualified Payment Amount (QPA) was used to calculate the member cost share(s).',
    'N861': 'Alert:\xa0Mismatch between the submitted Patient Liability/Share of Cost and the amount on record for this recipient.',
    'N862': 'Alert:\xa0Member cost share is in compliance with the No Surprises Act, and is calculated using the lesser of the QPA or billed charge.',
    'N863': 'Alert:\xa0This claim is subject to the No Surprises Act (NSA). The amount paid is the final out-of-network rate and was calculated based on an All Payer Model Agreement, in accordance with the NSA.',
    'N864': 'Alert:\xa0This claim is subject to the No Surprises Act provisions that apply to emergency services.',
    'N865': 'Alert:\xa0This claim is subject to the No Surprises Act provisions that apply to nonemergency services furnished by nonparticipating providers during a patient visit to a participating facility.',
    'N866': 'Alert:\xa0This claim is subject to the No Surprises Act provisions that apply to services furnished by nonparticipating providers of air ambulance services.',
    'N867': 'Alert:\xa0Cost sharing was calculated based on a specified state law, in accordance with the No Surprises Act.',
    'N868': 'Alert:\xa0Cost sharing was calculated based on an All-Payer Model Agreement, in accordance with the No Surprises Act.',
    'N869': 'Alert:\xa0Cost sharing was calculated based on the qualifying payment amount, in accordance with the No Surprises Act.',
    'N870': 'Alert:\xa0In accordance with the No Surprises Act, cost sharing was based on the billed amount because the billed amount was lower than the qualifying payment amount.',
    'N871': 'Alert:\xa0This initial payment was calculated based on a specified state law, in accordance with the No Surprises Act.',
    'N872': 'Alert:\xa0This final payment was calculated based on a specified state law, in accordance with the No Surprises Act.',
    'N873': 'Alert:\xa0This final payment was calculated based on an All-Payer Model Agreement, in accordance with the No Surprises Act.',
    'N874': 'Alert:\xa0This final payment was determined through open negotiation, in accordance with the No Surprises Act.',
    'N875': 'Alert:\xa0This final payment equals the amount selected as the out-of-network rate by a Federal Independent Dispute Resolution Entity, in accordance with the No Surprises Act.',
    'N876': 'Alert:\xa0This item or service is covered under the plan. This is a notice of denial of payment provided in accordance with the No Surprises Act. The provider or facility may initiate open negotiation if they desire to negotiate a higher out-of-network rate than the amount paid by the patient in cost sharing.',
    'N877': 'Alert:\xa0This initial payment is provided in accordance with the No Surprises Act. The provider or facility may initiate open negotiation if they desire to negotiate a higher out-of-network rate.',
    'N878': 'Alert:\xa0The provider or facility specified that notice was provided and consent to balance bill obtained, but notice and consent was not provided and obtained in a manner consistent with applicable Federal law. Thus, cost sharing and the total amount paid have been calculated based on the requirements under the No Surprises Act, and balance billing is prohibited.',
    'N879': 'Alert:\xa0The notice and consent to balance bill, and to be charged out-of-network cost sharing, that was obtained from the patient with regard to the billed services, is not permitted for these services. Thus, cost sharing and the total amount paid have been calculated based on the requirements under the No Surprises Act, and balance billing is prohibited.',
    ...
    'N882': "Alert:\xa0The out-of-network payment and cost sharing amounts were based on the plan's allowance because the provider or facility obtained the patient's consent to waive the balance billing protections under the No Surprises Act.",
    'N883': 'Alert:\xa0Processed according to state law',
    'N884': 'Alert:\xa0The No Surprises Act may apply to this claim. Please contact payer for instructions on how to submit information regarding whether or not the item or service was furnished during a patient visit to a participating facility.',
    'N885': 'Alert:\xa0This claim was not processed in accordance with the No Surprises Act cost-sharing or out-of-network payment requirements. The payer disagrees with your determination that those requirements apply. You may contact the payer to find out why it disagrees. You may appeal this adverse determination on behalf of the patient through the payer’s internal appeals and external review processes.',
    'N886': 'Alert:\xa0A Health Care Claim Request for Additional Information (277 RFAI) has been sent.',
    ...
    'N888': 'Alert:\xa0An electronic request for additional information has been sent for this claim.',
    'N889': 'Alert:\xa0This claim was originally processed in real-time, and we sent a real-time 835 response.',
    ...
    'N924': 'Pending (Not Denied) - The Medicare Advantage Organization (MAO) has not yet made a payment responsibility determination for the service at the time the encounter record was submitted.',
    'N925': 'Denied - The Medicare Advantage Organization (MAO) determined that it had no payment responsibility for the service at the time the encounter record was submitted.',
    'N926': 'Partially Denied - The Medicare Advantage Organization (MAO) determined that it had no payment responsibility for one or more service lines, but not all, at the time the encounter record was submitted.',
    ...
    'N935': 'Alert:\xa0Patient is no longer a Medicaid/Qualified Medicare Beneficiary.',
    ...
    'N938': 'Alert:\xa0Do not resubmit. This claim will be automatically reprocessed.',
    'N939': 'Alert:\xa0You may contact us for a peer-to-peer review.',
